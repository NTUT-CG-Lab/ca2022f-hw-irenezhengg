...
export const CubismDefaultParameterId = Object.freeze<Record<string, string>>({
  ...
  ParamTear: 'ParamTear',
  ParamScarf: 'ParamScarf',
  ParamBodyUpper: 'ParamBodyUpper',
  ParamHandChangeR: 'ParamHandChangeR',
  ParamHandAngleR: 'ParamHandAngleR',
  ParamHandDhangeL: 'ParamHandDhangeL',
  ParamHandAngleL: 'ParamHandAngleL'
});
...
export namespace Live2DCubismFramework {
  ...
  //spec
  export const ParamTere = $.CubismDefaultParameterId.ParamTere;
  export const ParamFaceForm = $.CubismDefaultParameterId.ParamFaceForm;
  export const ParamEyeForm = $.CubismDefaultParameterId.ParamEyeForm;
  export const ParamTear = $.CubismDefaultParameterId.ParamTear;
  export const ParamScarf = $.CubismDefaultParameterId.ParamScarf;
  export const ParamBodyUpper = $.CubismDefaultParameterId.ParamBodyUpper;
  export const ParamHandChangeR = $.CubismDefaultParameterId.ParamHandChangeR;
  export const ParamHandAngleR = $.CubismDefaultParameterId.ParamHandAngleR;
  export const ParamHandDhangeL = $.CubismDefaultParameterId.ParamHandDhangeL;
  export const ParamHandAngleL = $.CubismDefaultParameterId.ParamHandAngleL;
}
